...
INSERT INTO "new_CodSettings" ("blockedIps", "blockedPostalCodes", "buttonText", "codFee", "enabled", "freeShippingThreshold", "headingText", "ipBlockingEnabled", "maxOrdersPerPhone", "orderTag", "otpEnabled", "phoneConfirmation", "shippingRate", "shop", "showAddress", "showCity", "showEmail", "showName", "showNotes", "showPhone", "showQuantity", "successMessage", "updatedAt") SELECT "blockedIps", "blockedPostalCodes", "buttonText", "codFee", "enabled", "freeShippingThreshold", "headingText", "ipBlockingEnabled", "maxOrdersPerPhone", "orderTag", "otpEnabled", "phoneConfirmation", "shippingRate", "shop", "showAddress", "showCity", "showEmail", "showName", "showNotes", "showPhone", "showQuantity", "successMessage", "updatedAt" FROM "CodSettings";
